...
struct PhysicalSky final : public Feature
{
	...
	inline std::string GetDisplayName() override { return T("feature.physical_sky.name", "Physical Sky"); }
	...
	{
		return {
			T("feature.physical_sky.description", "Physically based sky models for photorealistic sky gradients, plus other astronomical effects."),
			{
