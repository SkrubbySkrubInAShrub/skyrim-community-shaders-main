...
struct ScreenSpaceRayTracing : Feature
{
	...
	virtual inline std::string GetDisplayName() override { return T("feature.screen_space_ray_tracing.name", "Screen Space Ray Tracing"); }
	...
	{
		return {
			T("feature.screen_space_ray_tracing.description", "Screen Space Ray Tracing provides high-quality global illumination with information in screen space."),
			{ T("feature.screen_space_ray_tracing.key_feature_1", "Realistic indirect lighting"),
				T("feature.screen_space_ray_tracing.key_feature_2", "Importance sampling for advanced reflections based on roughness"),
				T("feature.screen_space_ray_tracing.key_feature_3", "Efficient ray marching with Hi-Z buffer"),
				T("feature.screen_space_ray_tracing.key_feature_4", "Uses dynamic cubemaps as fallback for missing information"),
				T("feature.screen_space_ray_tracing.key_feature_5", "Spatiotemporal Variance-Guided Filtering (SVGF) denoiser") }
		};
	}
