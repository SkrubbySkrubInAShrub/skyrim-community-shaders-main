...
#define WATER_HEIGHT_UNMAPPED_SENTINEL -1e29f
#define WATER_DISTANCE_DRY 1e6f

#define WATER_MAP_MODE_OFF 0.0f
#define WATER_MAP_MODE_PARTIAL 1.0f
#define WATER_MAP_MODE_AUTHORITATIVE 2.0f
